...
<body>
	...
	<pre>
		...
		&lt;c:remove&gt; : removeAtrribute() 메소드와 같은 역할
					page | request | session | application 범위 객체에 속성값을 삭제하는 기능
	
	</pre>
<%
	// attribute 를 request 에 추가하려면 스티립트릿에서
...
<pre> 
EL : 성 : \${requestScope.surnmae} = ${requestScope.surname}
	 이름 : \${name } = ${name }
